...
TEST_F(UniformFloodingConsensusTest, test_proposal_will_send_message_to_everyone) {
    ...
    ASSERT_EQ(::get_string_messages().size(), 4);
    ASSERT_EQ(::get_string_senders()[0], 0);
    ASSERT_EQ(::get_string_senders()[1], 0);
    ASSERT_EQ(::get_string_receivers()[0], 1);
    ASSERT_EQ(::get_string_receivers()[1], 2);
    ASSERT_EQ(::get_string_receivers()[2], 1);
    ASSERT_EQ(::get_string_receivers()[3], 2);
}
...
TEST_F(UniformFloodingConsensusTest, test_decision_is_minimal_number) {
    ...
    ASSERT_EQ(::get_string_messages().size(), 12);
    ASSERT_EQ(::get_string_receivers()[0], 1);
    ASSERT_EQ(::get_string_receivers()[1], 2);
    ASSERT_EQ(::get_string_receivers()[2], 1);
    ASSERT_EQ(::get_string_receivers()[3], 2);
    ASSERT_EQ(::get_string_receivers()[4], 0);
    ASSERT_EQ(::get_string_receivers()[5], 2);
    ASSERT_EQ(::get_string_receivers()[6], 0);
    ASSERT_EQ(::get_string_receivers()[7], 2);
    ASSERT_EQ(::get_string_receivers()[8], 0);
    ASSERT_EQ(::get_string_receivers()[9], 1);
    ASSERT_EQ(::get_string_receivers()[10], 0);
    ASSERT_EQ(::get_string_receivers()[11], 1);
    ASSERT_EQ(::get_string_messages()[0], "PROPOSAL ");
    ASSERT_EQ(::get_string_messages()[2], "10");
    ASSERT_EQ(::get_string_messages()[3], "10");
    ASSERT_EQ(::get_string_messages()[6], "11");
    ASSERT_EQ(::get_string_messages()[7], "11");
    ASSERT_EQ(::get_string_messages()[10], "12");
    ASSERT_EQ(::get_string_messages()[11], "12");
